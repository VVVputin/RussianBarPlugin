...
public class RussianProgressBarUi extends BasicProgressBarUI {
    private static final float ONE_OVER_SEVEN = 1f / 3;

    @SuppressWarnings({"MethodOverridesStaticMethodOfSuperclass", "UnusedDeclaration"})
    public static ComponentUI createUI(JComponent c) {
        c.setBorder(JBUI.Borders.empty().asUIResource());
        return new RussianProgressBarUi();
    }
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        Icons.GERB.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
